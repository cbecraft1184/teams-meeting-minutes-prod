    ...
    <div className={styles.container} data-testid="page-help">
      <div className={styles.header}>
        ...
        <Text className={styles.subtitle}>
          Complete guide to using the Meeting Minutes application
        </Text>
      </div>
      ...
      <section className={styles.section}>
        ...
        <Card className={styles.card}>
          <Accordion collapsible>
            <AccordionItem value="view-minutes">
      ...
      <section className={styles.section}>
        ...
        <Card className={styles.card}>
          <Accordion collapsible>
            <AccordionItem value="no-meeting">
            ...
            <AccordionItem value="no-minutes">
            ...
            <AccordionItem value="cant-approve">
            ...
            <AccordionItem value="login-issue">
      ...
      <section className={styles.section}>
        ...
        <Card className={styles.card}>
          <p className={styles.paragraph}>
            If you're experiencing issues that aren't covered above:
          </p>
          <ol className={styles.list}>
            <li className={styles.listItem}>
              <strong>Check this Help page</strong> - Most common questions are answered here.
            </li>
            <li className={styles.listItem}>
              <strong>Contact your IT administrator</strong> - For access issues, permissions, or 
              technical problems.
            </li>
            <li className={styles.listItem}>
              <strong>Report bugs</strong> - If you find a bug, note what you were doing when it 
              happened and report it to your administrator.
            </li>
          </ol>
          <div className={styles.infoBox}>
            <Text>
              <strong>Pro Tip:</strong> When reporting issues, include the meeting name, date/time, 
              and a screenshot of any error messages. This helps resolve problems faster.
            </Text>
          </div>
        </Card>
      </section>
