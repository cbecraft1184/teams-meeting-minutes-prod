...
**Document Purpose:** Comprehensive security architecture and compliance framework for SOC 2 Type II, enterprise security standards IL5, and DOD RMF authorization in Azure Commercial
...
- enterprise security standards Cloud Computing Security Requirements Guide (IL5)
- DOD Risk Management Framework (RMF) authorization
- Classification handling (Standard, Enhanced, Premium security tiers)
...
```yaml
Classification Support: Standard, Enhanced, Premium security tiers
Impact Level: IL5 (DOD)
Compliance Frameworks:
  - SOC 2 Type II
  - enterprise security standards Level 5
  - enterprise security standards Rev 5 (High Baseline)
  - DOD RMF
...
| Control Family | enterprise security standards | Implementation Owner | Status |
|----------------|-------------|---------------------|--------|
...
### enterprise security standards IL5 Requirements
...
- ✅ enterprise security standards IL5 requirements met
