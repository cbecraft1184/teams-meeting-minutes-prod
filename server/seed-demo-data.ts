  ...
  const demoMeetings = [
    {
      ...
      duration: '2 hours',
      attendees: ['admin@dod.test', 'approver@dod.test', 'auditor@dod.test', 'john.doe@dod.gov'],
    ...
    },
    {
      ...
      attendees: ['approver@dod.test', 'auditor@dod.test', 'admin@dod.test'],
      organizerAadId: '00000000-0000-0000-0000-000000000002',
      status: 'completed' as const,
    ...
    },
    {
      ...
      duration: '1 hour',
      attendees: ['john.doe@dod.gov', 'admin@dod.test'],
    ...
    },
    {
      ...
      duration: '30 minutes',
      attendees: ['auditor@dod.test', 'approver@dod.test', 'admin@dod.test'],
      organizerAadId: '00000000-0000-0000-0000-000000000003',
      status: 'completed' as const,
      classificationLevel: 'UNCLASSIFIED' as const,
      teamsJoinLink: 'https://teams.microsoft.com/l/meetup-join/...',
    ...
    },
    {
      ...
      duration: '1 hour',
      attendees: ['approver@dod.test', 'auditor@dod.test'],
      organizerAadId: '00000000-0000-0000-0000-000000000002',
    ...
    },
    {
      ...
      scheduledAt: new Date(now.getTime() + 2 * 24 * 60 * 60 * 1000),
      duration: '2 hours',
      attendees: ['john.doe@dod.gov', 'auditor@dod.test', 'admin@dod.test'],
      organizerAadId: '00000000-0000-0000-0000-000000000001',
  ...
  const minutesData = [
    {
      ...
      attendeesPresent: ['john.doe@dod.gov', 'approver@dod.test', 'auditor@dod.test', 'admin@dod.test'],
      processingStatus: 'completed' as const,
      approvalStatus: 'approved' as const,
      approvedBy: 'john.doe@dod.gov',
    ...
    },
    {
      ...
      attendeesPresent: ['approver@dod.test', 'auditor@dod.test', 'admin@dod.test'],
      processingStatus: 'completed' as const,
      approvalStatus: 'approved' as const,
      approvedBy: 'approver@dod.test',
    ...
    },
    {
      ...
      attendeesPresent: ['john.doe@dod.gov', 'admin@dod.test'],
      processingStatus: 'completed' as const,
      approvalStatus: 'approved' as const,
      approvedBy: 'john.doe@dod.gov',
    ...
    },
    {
      ...
      attendeesPresent: ['auditor@dod.test', 'approver@dod.test', 'admin@dod.test'],
      processingStatus: 'completed' as const,
