...
async function seedDemoData() {
  ...
  const demoMeetings = [
    ...
    },
    {
      ...
      attendees: ['john.doe@dod.gov', 'approver@dod.test', 'auditor@dod.test', 'admin@dod.test'],
    ...
    },
    {
      ...
      duration: '30 minutes',
      attendees: ['john.doe@dod.gov', 'auditor@dod.test', 'approver@dod.test', 'admin@dod.test'],
    ...
    },
    {
      ...
      duration: '1 hour',
      attendees: ['john.doe@dod.gov', 'approver@dod.test', 'auditor@dod.test'],
      organizerAadId: '00000000-0000-0000-0000-000approver001',
