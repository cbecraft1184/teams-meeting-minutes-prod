  ...
  try {
    ...
    await db.insert(meetingTemplates).values([
      ...
      },
      {
        ...
        defaultDuration: "1h 30m",
        defaultClassification: "CONFIDENTIAL",
        suggestedAttendees: ["security.officer@contoso.com", "compliance.officer@contoso.com", "it.security@contoso.com"],
        agendaItems: [
    ...
    const [meeting1] = await db.insert(meetings).values({
      ...
      duration: "1h 30m",
      attendees: ["john.doe@contoso.com", "jane.smith@contoso.com", "bob.johnson@contoso.com"],
      status: "completed",
    ...
    const [meeting2] = await db.insert(meetings).values({
      ...
      duration: "2h",
      attendees: ["security.officer@contoso.com", "architect@contoso.com", "compliance@contoso.com"],
      status: "completed",
    ...
    const [meeting3] = await db.insert(meetings).values({
      ...
      duration: "1h",
      attendees: ["emergency.coord@contoso.com", "ops.manager@contoso.com"],
      status: "in_progress",
